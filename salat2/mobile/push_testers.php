...
$_Proccess_Main_DB_Table = "tb_push__testers";
...
$parameters_typesArr = configManager::$parameters_typesArr;
...
function module_updateStaticFiles() {
	...
	/*if($_Proccess_Has_MultiLangs){
		$UpdateStatic = new parametersLangsUpdateStaticFiles();
		$UpdateStatic->updateStatics();
	}else{
		$UpdateStatic = new parametersUpdateStaticFiles();
		$UpdateStatic->updateStatics();
	}*/
}
