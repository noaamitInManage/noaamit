...
$fieldsArr = array(
	...
	'image-iphone5' => array(
		...
		'comments' => array(
			'show' => '',
			'add' => '640x1136<br/>png only',
			'new' => '640x1136<br/>png only',
		),
		'input' => array(
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				...
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => '_media/splash/{id}-iphone5.png', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'none', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'image-iphone4' => array(
		...
		'comments' => array(
			'show' => '',
			'add' => '640x960<br/>png only',
			'new' => '640x960<br/>png only',
		),
		'input' => array(
			'type' => 'file', // choose: none|text|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
			'extra_after' => '', // extra code/text after element tag
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'path', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => '_media/splash/{id}-iphone4.png', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'none', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'image-iphone3' => array(
		...
		'comments' => array(
			'show' => '',
			'add' => '320x480<br/>png only',
			'new' => '320x480<br/>png only',
		),
		'input' => array(
			'type' => 'file', // choose: none|text|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
			'extra_after' => '', // extra code/text after element tag
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'path', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => '_media/splash/{id}-iphone3.png', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'none', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'image-andriod' => array(
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'path', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => '_media/splash/{id}-andriod.png', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'none', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'image-andriod-hdpi' => array(
		...
		'comments' => array(
			'show' => '',
			'add' => '800X480<br/>png only',
			'new' => '800X480<br/>png only',
		),
		'input' => array(
			'type' => 'file', // choose: none|text|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
			'extra_after' => '', // extra code/text after element tag
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'path', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => '_media/splash/{id}-andriod-hdpi.png', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'none', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'image-andriod-xhdpi' => array(
		...
		'comments' => array(
			'show' => '',
			'add' => '1280X720<br/>png only',
			'new' => '1280X720<br/>png only',
		),
		'input' => array(
			'type' => 'file', // choose: none|text|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
			'extra_after' => '', // extra code/text after element tag
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'path', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => '_media/splash/{id}-andriod-xhdpi.png', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'none', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'image-andriod-tablet' => array(
		...
		'comments' => array(
			'show' => '',
			'add' => '1280X800<br/>png only',
			'new' => '1280X800<br/>png only',
		),
		'input' => array(
			'type' => 'file', // choose: none|text|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
			'extra_after' => '', // extra code/text after element tag
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'path', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => '_media/splash/{id}-andriod-tablet.png', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'none', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
