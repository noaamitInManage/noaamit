...
$_Proccess_Main_DB_Table = "tb_advertisers_types";
...
function module_updateStaticFiles() {
	...
	$UpdateStatic = new advertisersTypesUpdateStaticFiles();
...
$(function() {
   ...
   /*  auto media load */
	   ...
	   $("#media_category_sel").live('change',function(event){
            $.get('/salat2/_ajax/ajax.index.php', { 'file': 'auto_complete/media_category' ,'category': $(this).val() ,'action' : 'getSelcetItems' }, function(response) {
