...
class campaignUpdateStaticFiles extends moduleUpdateStaticFiles implements iUpdate
{
    ...
    {
        parent::__construct();
        $this->_Proccess_Main_DB_Table = 'tb_campaign';
        $this->_ProcessID = 31;
        $this->className = trim(get_class());
        $this->file_name = 'campaigns.inc.php';
        $this->itemsArr_name = 'campaignsArr';
        $this->name = 'קמפיינים';
    }
