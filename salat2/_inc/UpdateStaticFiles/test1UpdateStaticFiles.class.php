...
class test1UpdateStaticFiles extends moduleUpdateStaticFiles implements iUpdate
{
    //public $_Proccess_Main_DB_Table,$_ProcessID;
    public $className, $file_name, $itemsArr_name, $name, $lang_id;

    private static $element_name = "test1"; // in single form. ALWAYS in single form
