...
class auto_testUpdateStaticFiles extends moduleUpdateStaticFiles implements iUpdate
{
    //public $_Proccess_Main_DB_Table,$_ProcessID;
    public $className, $file_name, $itemsArr_name, $name, $lang_id;

    private static $element_name = "auto_test"; // in single form. ALWAYS in single form
