...
$fieldsArr = array(
	...
	'page' => array(
		...
		'comments' => array(
			'show' => '',
			'add' => '<span style="color:red;font-size:10px;">example: article.php</span>',
			'new' => '<span style="color:red;font-size:10px;">example: article.php</span>',
		),
		'input' => array(
			'type' => 'text', // choose: none|text|textarea|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
			'extra_after' => '', // extra code/text after element tag
	...
	'parentid' => array(
		...
		'value' => array(
			'show' => array( // `key` is the action name
				...
				'details' => '$parentProcesses[{VALUE}]', // value is "{VALUE}" (without quotes)
			),
			'new' => array( // `key` is the action name
				'source' => 'array', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => '$parentProcesses', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'post', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'show_order' => array(
		...
		'input' => array(
			'type' => 'text', // choose: none|text|textarea|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
			'extra_after' => '', // extra code/text after element tag
			'extra_html' => 'id="show_order_num"', // extra attribues for the element tag
		),
		'value' => array(
			'show' => array( // `key` is the action name
				'source' => 'function', // choose: none|array|function|db|var, none for no visibility
	...
	'icon_id' => array(
		...
		'order_by' => false,
		'comments' => array(
			'show' => 'יש להעלות תמונות ברזולוציה המתאימה בלבד <br/><b>(10x10)</b>',
			'add' => 'יש להעלות תמונות ברזולוציה המתאימה בלבד <br/><b>(10x10)</b>',
			'new' => 'יש להעלות תמונות ברזולוציה המתאימה בלבד <br/><b>(10x10)</b>',
		),
		'input' => array(
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				...
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => "mediaSelector('icon_id')", // value is "{VALUE}" (without quotes) 'media_id',array('media_id'=>array('iphone3'=>'200x350','hdpi'=>'450x150'))
			),
			'after' => array( // `key` is the action name
				'source' => 'post', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
