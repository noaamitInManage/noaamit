...
include_once($_project_server_path."_static/generalContentCategories.inc.php"); // $generalContentCategoriesArr

$_Proccess_Main_DB_Table = "tb_general_content";
...
function module_updateStaticFiles() {
	...
	if($_Proccess_Has_MultiLangs){
		$UpdateStatic = new general_contentLangsUpdateStaticFiles();
		$UpdateStatic->updateStatics();
//	}else{
//		$UpdateStatic = new general_contentUpdateStaticFiles();
//		$UpdateStatic->updateStatics();
	}
