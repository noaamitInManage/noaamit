...
$fieldsArr = array(
	...
	'select_array' => array(
		...
		'value' => array(
			'show' => array( // `key` is the action name
				...
				'details' => '$selectArr["{VALUE}"]', // value is "{VALUE}" (without quotes)
			),
			'new' => array( // `key` is the action name
				...
				'details' => '$selectArr', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'post', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => '-- Choose --'), // e.g. "Please choose category"
	...
	'int_field' => array(
		...
		'input' => array(
			'type' => 'text', // choose: none|text|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
			'extra_after' => '', // extra code/text after element tag
			'extra_html' => 'id="numOnly"', // extra attribues for the element tag
			'searchable'=>false // genric search
		),
		'value' => array(
			'show' => array( // `key` is the action name
	...
	'radio_array' => array(
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'array', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => '-- Choose --'), // e.g. "Please choose category"
				'details' => '$radioArr', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'post', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => '-- Choose --'), // e.g. "Please choose category"
	...
	'gallery_id' => array(
		...
		'comments' => array(
			'show' => '',
			'add' => 'יש להעלות תמונות ברזולוציה המתאימה בלבד <br/><b>(901x195)</b>',
			'new' => 'יש להעלות תמונות ברזולוציה המתאימה בלבד <br/><b>(901x195)</b>',
		),
		'input' => array(
			'type' => 'select', // choose: none|text|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
			'extra_after' =>  '<br><a href="#" id="add_gallery">הוסף גלריה</a>', // extra code/text after element tag
			'extra_html' => 'id="gallery_id" class="gallery_media must"', // extra attribues for the element tag
			'searchable' => false, // extra attribues for the element tag
		),
		'value' => array(
			'show' => array( // `key` is the action name
				'source' => 'none', // choose: none|array|function|db|var, none for no visibility
				'details' => '$mediaCategorysArr[{VALUE}]', // value is "{VALUE}" (without quotes)
			),
			'new' => array( // `key` is the action name
				'source' => 'array', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '0', 'text' => 'בחר'), // e.g. "Please choose category"
				'details' => '$mediaCategorysArr', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'post', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'_gallery_id_' => array(
		...
		'input' => array(
			...
			'extra_after' => '', // extra code/text after element tag
			'extra_html' => 'id="gallery_id_items" class="gallery_media_items"', // extra attribues for the element tag
			'searchable' => false, // extra attribues for the element tag
		),
		'value' => array(
			'show' => array( // `key` is the action name
			...
			'new' => array( // `key` is the action name
				...
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => 'draw_genric_gallery_images({gallery_id})', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'none', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
...
//		'comments' => array(
//			'show' => '',
//			'add' => 'יש להעלות תמונות ברזולוציה המתאימה בלבד <br/><b>(416x426)</b>',
//			'new' => 'יש להעלות תמונות ברזולוציה המתאימה בלבד <br/><b>(416x426)</b>',
//		),
//		'input' => array(
//			'type' => 'label', // choose: none|text|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
//			'extra_after' =>  '', // extra code/text after element tag
...
//				'source' => 'function', // choose: none|array|function|db|var|path, none for no visibility
//				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
//				'details' => 'draw_gallery_upload("gallery_id","gallery_new_id")', // value is "{VALUE}" (without quotes)
//			),
//			'after' => array( // `key` is the action name
//				'source' => 'post', // choose: none|post|array|function|db|var, none for no visibility
//				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
...
//			'type' => 'label', // choose: none|text|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
//			'extra_after' => '', // extra code/text after element tag
//			'extra_html' => 'id="gallery_new_id_items" class="gallery_new_media_items"', // extra attribues for the element tag
//			'searchable' => false, // extra attribues for the element tag
//		),
//		'value' => array(
//			'show' => array( // `key` is the action name
...
//	),
	...
	'media_id' => array(
		...
		'order_by' => false,
		'comments' => array(
			'show' => 'יש להעלות תמונות ברזולוציה המתאימה בלבד <br/><b>(901x195)</b>',
			'add' => 'יש להעלות תמונות ברזולוציה המתאימה בלבד <br/><b>(901x195)</b>',
			'new' => 'יש להעלות תמונות ברזולוציה המתאימה בלבד <br/><b>(901x195)</b>',
		),
		'input' => array(
	...
	'textarea' => array(
		...
		'input' => array(
			...
			'toolbar'=>'',// choose : None|Full|Basic|Inmanage,
			'extra_after' => '', // extra code/text after element tag
			'extra_html' => '', // extra attribues for the element tag
			'searchable'=>false, // genric search
		),
	...
	'bitwise_array' => array(
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'function', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => "drawBitwiseFlagSelection('some_bit_Arr','{VALUE}')", // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'function', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' =>  "calculateBitwiseFlagSelection('some_bit_Arr')", // value is "{VALUE}" (without quotes)
			),
		),
	),

	'label' => array(
		'title' => 'טקסט ללא עריכה',
		'type' => 'string', // choose: int|float|string
		'table' => '',
		'order_by' => false,
		'comments' => array(
	...
	'full_address' => array(
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'function', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => 'getGpsField()', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'post', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'date' => array(
		...
		'input' => array(
			'type' => 'datepicker', // choose: none|text|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
			'extra_after' => '', // extra code/text after element tag
			'extra_html' =>  '', // extra attribues for the element tag
		),
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'db', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => 'd-m-Y', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'function', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'function' => array(
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'function', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => "some_function()", // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'post', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'json_polygon' => array(
		...
		'input' => array(
			'type' => 'maps', // choose: none|text|select|radio|checkbox|timepicker|datepicker|datetimepicker|htmltext(WYSIWYG)
			'extra_after' => '', // extra code/text after element tag
			'extra_html' => '', // extra attribues for the element tag
		),
		'value' => array(
			'show' => array( // `key` is the action name
				'source' => 'none', // choose: none|array|function|db|var, none for no visibility
				'details' => "fields_draw_title_link({MEIT_Number}, '{VALUE}')", // value is "{VALUE}" (without quotes)
			),
			'new' => array( // `key` is the action name
				'source' => 'polygon', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
				'details' => '{VALUE}', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'post', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
	...
	'user_salat_id' => array(
		...
		'value' => array(
			...
			'new' => array( // `key` is the action name
				'source' => 'none', // choose: none|array|function|db|var|path, none for no visibility
				'dummy' => array('value' => '', 'text' => '-בחר-'), // e.g. "Please choose category"
				'details' => 'get_user_update()', // value is "{VALUE}" (without quotes)
			),
			'after' => array( // `key` is the action name
				'source' => 'post', // choose: none|post|array|function|db|var, none for no visibility
				'dummy' => array('value' => '', 'text' => ''), // e.g. "Please choose category"
