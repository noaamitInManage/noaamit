...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"מציג _MENU_ נתונים",sZeroRecords:"אין נתונים",sEmptyTable:"אין נתונים",
sLoadingRecords:"טוען...",sInfo:"מציג _START_ מתוך _END_ מתוך _TOTAL_ נתונים",sInfoEmpty:"מציג 0 מתוך 0 of 0 נתונים ",sInfoFiltered:"(סונן מ _MAX_ סה'כ נתונים )",sInfoPostFix:"",sInfoThousands:",",sSearch:"חיפוש:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
